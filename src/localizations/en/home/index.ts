const enHomeLocale = {
    description: {
        ...
        description1: `Hello 👋! 
					   ...
					   <br><div class='space'></div>
					   My expertise <span class="underline">will save you a lot of time and money</span> 💸
					   <br><div class='space'></div>
    ...
    portfolio: {
        subTitle: 'why me?',
        title: 'I am someone that has done it many times. Here are my latest projects.\u00A0😎'
    },
    quotes: {
        reviews: [
            {
