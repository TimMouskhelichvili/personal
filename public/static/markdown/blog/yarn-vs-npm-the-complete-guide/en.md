...
Npm is directly installed when you install Node.js so if you have Node.js you have npm. If you don't have node.js go [here](https://nodejs.org/) and download the LTS version of Node.js.
...
To make it consistent across all environments, when a package manager modifies node_modules or package.json, it stores all the versions of the packages inside a special lock file. This lock file is auto-generated and managed by the package manager. 
